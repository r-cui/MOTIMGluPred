...
@gin.configurable()
def timl(datetime_feats: int, layer_size: int, inr_layers: int, n_fourier_feats: int, scales: float):
    return TIML(datetime_feats, layer_size, inr_layers, n_fourier_feats, scales)
